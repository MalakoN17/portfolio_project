...
function ProjectItem({title, backgroundImg, projectUrl}) {
  ...
  return (
    <div data-aos="zoom-in" data-aos-duration="2000" className='relative flex items-center justify-center h-auto shadow-xl p-4 rounded-lg group hover:bg-gradient-to-r from-[#aba6a6] to-[#226bc0]'>
