    ...
    <div id='about' className='about-container md:h-screen'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        ...
        I am currently looking for a job as a junior Full-Stack developer.
            ...
            <Link href='/Projects' className='py-2 text-black underline cursor-pointer'>
              Check out some of my latest projects.
            </Link>
        </div>
        <div data-aos="flip-left"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="1000" className='w-full h-auto m-auto shadow-xl shadow-black rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300'>
